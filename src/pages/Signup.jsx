      ...
      <div className="flex bg-gray-100 justify-center min-h-screen">
        <div className="bg-white w-120 h-120 mt-27 rounded-l-xl shadow-2xl">
          <img
            src={signup}
            alt="signup logo"
            className="h-110 w-110 mx-auto my-5 rounded-2xl"
          />
        </div>
        <div className="bg-black w-120 h-120 mt-27 rounded-r-2xl justify-items-center shadow-2xl">
          <h3 className="font-poppins font-semibold mt-4 text-my-colour">
            Sign up
          </h3>

          <form
            className=" text-center lg:text-start my-2 rounded-2xl w-100 h-106"
          ...
          >
            ...
            <span className="text-my-colour pr-2">
